    ...
    <div class="min-h-screen bg-zinc-950 flex flex-col justify-center items-center p-6 relative overflow-hidden">
      ...
      <div class="w-full max-w-md bg-zinc-900/80 backdrop-blur-xl border border-zinc-800 rounded-3xl shadow-2xl p-8 relative z-10">
        ...
        <div class="flex flex-col items-center mb-10">
          ...
          <p class="text-xs text-zinc-500 uppercase tracking-widest font-bold mt-1">Acesso Restrito Konig Systems</p>
        </div>
        ...
        <div class="mt-8 pt-6 border-t border-zinc-800 text-center">
          <p class="text-[9px] text-zinc-600 uppercase font-bold tracking-widest mb-4">Problemas com acesso? Contate o Administrador.</p>
...
export class AuthComponent {
  ...
  async handleSubmit(e: Event) {
    ...
    try {
      ...
      this.errorMessage.set(err.message || 'Credenciais inválidas ou acesso negado.');
    } finally {
